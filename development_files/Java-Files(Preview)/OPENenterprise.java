...
import static AppPages.LearningCV.jTextField1;
import static AppPages.LearningCV.jTextField6;
 ...
 */
public class OPENenterprise extends javax.swing.JFrame {

    /**
     * Creates new form BASEPage
     */
    public OPENenterprise() {
        //setting resolution
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AppPages/ugcs-enterprise-universal-ground-control-softwareM.png"))); // NOI18N
 ...
 new Software().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OPENenterprise.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OPENenterprise().setVisible(true);
            }
        });
    }
