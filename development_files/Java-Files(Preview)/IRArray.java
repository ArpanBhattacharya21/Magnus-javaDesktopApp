 ...
 */
public class IRArray extends javax.swing.JFrame {
...
ImageIcon icon= new ImageIcon("src/AppPages/MessageLogo.png");
        ...
        {
        Cart a= new Cart();
        Cart.name.setText(IRArray.jTextField1.getText());
        Cart.type.setText(IRArray.jTextField2.getText());
        Cart.cost.setText(IRArray.jTextField3.getText());
        }
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IRArray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
