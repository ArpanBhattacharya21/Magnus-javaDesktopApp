 ...
 */
public class BASEProduct extends javax.swing.JFrame {
...
ImageIcon icon= new ImageIcon("src/AppPages/MessageLogo.png");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BASEProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BASEProduct().setVisible(true);
            }
        });
    }
